...
interface OrderJpaRepository : CrudRepository<OrdersEntity, Long> {
    ...
    fun findByClientDocumentAndStatus(document: String, status: String) : List<OrdersEntity>
    fun findByNickNameAndStatus(nickName: String, status: String) : List<OrdersEntity>
